    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <tr class="d-flex">
          ...
          <td class="col-2 text-center"><input class="form-check-input" type="checkbox" value="si"></td>
          <td class="col-2 text-center"><input class="form-check-input" type="checkbox" value="no"></td>
