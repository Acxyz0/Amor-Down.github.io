...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <span class="navbar-text">Nombre de Usuario</span>
                    </li>
                    <li class="nav-item">
                        <span class="navbar-text">Rol: Administrador</span>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <main>
        ...
        <div class="sidebar">
            <div class="menu">
                <ul>
                <li><a href="inicio2.php"><i class="bi bi-house-fill"></i><span>Inicio</span></a></li>
                    <li><a href="#"><i class="fas fa-users"></i><span>Beneficiario</span></a>
                        <ul class="submenu">
                            <li><a href="Ficha de Ingreso.php"><span>Ficha de Ingreso</span></a></li>
                            <li><a href="Verbeneficiarios"><span>Ver beneficiario</span></a></li>
                    ...
                    <li><a href="#"><i class="fas fa-book"></i><span>Sesiones</span></a>
                        <ul class="submenu">
                            ...
                            <li><a href="versesiones"><span>Sesiones Asignadas</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="CRUD/IngresarUsuario.php"><i class="fas fa-users-cog"></i><span>Usuarios</span></a></li>
                    <li><a href="index.php"><i class="fas fa-sign-out-alt"></i><span>Cerrar Sesión</span></a></li>
                </ul>
            </div>
        </div>
